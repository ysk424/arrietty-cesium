...
$log=Join-Path $workspace ('logs/row/'+$Name+'.log')
New-Item -ItemType Directory -Force -Path (Split-Path $output) | Out-Null
$launchArgs=@(('"'+$project+'"'),'/Game/Row/Maps/CesiumRow','-game','-RowDemo','-RowDemoStraight','-nohmd','-DisablePlugins=OpenXR','-RenderOffscreen',
