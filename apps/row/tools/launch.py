...
from places import ROOT, WORKSPACE, PlaceError, resolve_place, confirmed, build_scene, request_json
...
def main():
    ...
    cfg_path=WORKSPACE/'config/cesium.local.json'
    ...
    logs=WORKSPACE/'logs/row';logs.mkdir(exist_ok=True)
