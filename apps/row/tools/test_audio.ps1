...
$log=Join-Path $workspace "logs/row/audio-runtime-$stamp.log"
$output=Join-Path $repo 'unreal/ArriettyCesium/Saved/AudioCapture/row-audio-demo.wav'
$began=Get-Date
$arguments=@(('"'+$project+'"'),'/Game/Row/Maps/CesiumRow','-game','-RowTestFixture','-RowDemo','-RowDemoStraight','-nohmd','-DisablePlugins=OpenXR',
